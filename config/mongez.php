...
return [
    ...
    */
    'database' => [
        ...
        'onModel' => [
            'update' => [
                // UpdatedModel::class => update options
            ],
            'delete' => [
                // DeletedModel::class => searchingColumn
            ],
            'deletePull' => [
                // DeletedModel::class => searchingColumn
            ],
    ...
    */
    'repositories' => [
        ...
        'guests' => App\Modules\Guests\Repositories\GuestsRepository::class,
    ...
    */
    'testing' => [
        'headers' => [],
        'response' => [
            'rootKey' => 'data', // each response is wrapped in a `data` key
        ],
        'accessToken' => [
            'route' => '/login/guests',
            ...
            'headers' => [
                'os' => 'web',
                'Authorization' => 'key ' . env('WEB_API_KEY'),
            ]
        ],
        'units' => [
